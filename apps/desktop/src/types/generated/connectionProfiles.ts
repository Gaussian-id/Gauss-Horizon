...
export const CONNECTION_PROFILES = {
  ...
  kingbase: { type: "kingbase", port: 54321, user: "system", label: "KingbaseES", icon: "kingbase" },
  highgo: { type: "highgo", port: 5866, user: "highgo", label: "HighGo", icon: "highgo" },
  ...
  dm: { type: "dameng", port: 5236, user: "SYSDBA", label: "Dameng", icon: "dm" },
  ...
  oscar: { type: "oscar", port: 2003, user: "SYSDBA", label: "OSCAR", icon: "oscar" },
...
export const CONNECTION_PICKER_OPTIONS = [
  ...
  { value: "goldendb", label: "GoldenDB", category: "domestic" },
  ...
  { value: "gbase", label: "GBase", category: "domestic" },
  ...
  { value: "kingbase", label: "KingbaseES", category: "domestic" },
  { value: "highgo", label: "HighGo", category: "domestic" },
  { value: "uxdb", label: "UXDB", category: "domestic" },
  { value: "yashandb", label: "YashanDB", category: "domestic" },
  { value: "vastbase", label: "Vastbase", category: "domestic" },
  ...
  { value: "dm", label: "Dameng", category: "domestic" },
  ...
  { value: "sundb", label: "SUNDB", category: "domestic" },
  { value: "oscar", label: "OSCAR", category: "domestic" },
