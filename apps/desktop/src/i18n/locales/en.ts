...
export default {
  ...
  pluginPlatform: {
    ...
    centerDescription: "Discover optional Chiron Horizon capabilities in one marketplace, then manage installed plugins and repositories separately.",
    ...
    marketplaceGuideDescription: "For plugin issues or feature requests, please open an issue in the plugin's own repository (use the source repository link on the plugin card); the main Chiron Horizon repository only handles issues with the app itself.",
    ...
    localInstallDescription: "Install a signed .chiron-horizonp obtained outside the marketplace from a local file or URL. Chiron Horizon verifies package integrity and signatures automatically.",
    repositoriesTitle: "Plugin repositories",
    repositoriesDescription: "The official source is signed and managed by Chiron Horizon. Custom repositories use one repository-level trust key configured below.",
    ...
    pluginDevelopmentDocsDescription: "Learn how to develop, package, and publish Chiron Horizon plugins to the marketplace.",
    ...
    allowUnsignedDevelopmentPackageDescription: "Applies only to manual .chiron-horizonp installation and never relaxes official marketplace verification.",
    installPackage: "Install .chiron-horizonp",
    installFromUrl: "Install from URL",
    installUrlPlaceholder: "https://example.com/plugin.chiron-horizonp",
    ...
    dropInstallHint: "You can also drop a .chiron-horizonp file onto this page",
    packageFileType: "Chiron Horizon plugin package",
    ...
    noInstalledPluginsDescription: "Install a signed .chiron-horizonp, or explicitly enable unsigned packages for local development.",
  ...
  externalSqlFile: {
    modifiedTitle: "File changed outside Chiron Horizon",
    ...
    deletedDescription: "{path} was deleted or moved outside Chiron Horizon. The editor content is still available.",
  ...
  updates: {
    ...
    availableMessage: "Chiron Horizon {latest} is available. You are using {current}.",
    upToDate: "Chiron Horizon is up to date ({version}).",
    ...
    downloadStarted: "Downloading Chiron Horizon {version} in the background.",
    activeTasksBlockUpdate: "{count} task(s) are still running. Wait for them to finish before updating Chiron Horizon.",
    portableAutomaticUpdate: "Chiron Horizon will download the signed portable ZIP, replace only Chiron Horizon.exe after exit, and restart automatically. portable.chiron_horizon and data will be kept.",
    ...
    readyToInstall: "Chiron Horizon {version} is ready to install.",
    installNow: "Install Now",
    installedReadyToRestart: "Chiron Horizon has been updated. Restart to finish.",
  ...
  sidebar: {
    ...
    importChironHorizon: "Import Chiron Horizon Config",
  ...
  sqlLibrary: {
    title: "SQL Library",
    storageHelp: "SQL Library content is stored in Chiron Horizon app data, not as standalone .sql files on disk.\nTo use files in the file system, export the SQL Library.",
  ...
  connection: {
    ...
    rememberPasswordSaveFailed: "Connected, but Chiron Horizon could not remember the password: {message}",
    ...
    oracleTnsPathHint: "The Chiron Horizon backend/Oracle agent reads this path. Desktop paths are local; Web and Docker paths are on the server.",
    ...
    nacosWebConsoleUrlHint: "Optional. Opens the Nacos console in your browser. Nacos 3 requires its separate web-console address; the browser needs direct access and does not reuse Chiron Horizon tunnels or API authentication.",
    ...
    kafkaKerberosKeytabPlaceholder: "Path on Chiron Horizon Agent machine, e.g. /etc/security/keytabs/user.keytab",
    kafkaKerberosKrb5ConfPlaceholder: "Optional path on Chiron Horizon Agent machine, e.g. /etc/krb5.conf",
    kafkaKerberosPathHint: "The keytab and krb5.conf paths are read by Chiron Horizon Agent and must exist on the machine running Chiron Horizon Agent; files are not uploaded from this browser.",
    ...
    gaussdbConnectionModeNativeHint: "Uses Chiron Horizon's built-in PostgreSQL-compatible protocol for GaussDB A/PG/Oracle compatibility modes.",
    ...
    agentJavaTooOld: "This driver requires Java 21. Use Chiron Horizon managed JRE 21 or select a Java 21 executable in Driver Manager.",
    ...
    sqliteWorkerPlacementSessionHint: "Chiron Horizon uploads the worker over SSH to the file host, then deletes the remote file when you disconnect. Suitable for temporary use.",
    sqliteWorkerPlacementPersistHint: "Chiron Horizon uploads the worker over SSH to the file host and leaves it there after disconnect. It is not deleted automatically.",
    sqliteWorkerPlacementPreplacedHint: "Upload the worker to the file host yourself, then enter the file's absolute path. Chiron Horizon will not upload or delete it automatically, but it will verify the file matches this Desktop version.",
    sqliteWorkerPlacementDefault: "Default",
    sqliteWorkerPersistPathPlaceholder: "~/.cache/chiron-horizon/sqlite-worker/<digest>",
    sqliteWorkerPreplacedPathPlaceholder: "/opt/chiron-horizon/chiron-horizon-sqlite-worker",
    sshWorkerUploadConsentTitle: "Upload SQLite Worker",
    sshWorkerUploadConsentMessage: "Chiron Horizon needs to copy a short-lived SQLite worker onto {host}:{port}. This is a privileged action. Review the destination path and digest before allowing the upload.",
    ...
    docsNotesPathPlaceholder: "docs/chiron-horizon-docs.json",
    ...
    httpTunnelTokenPlaceholder: "Token configured in chiron_horizon_tunnel.php",
    ...
    jdbcPluginHint: "Install the Chiron Horizon JDBC plugin first. For drivers with external dependencies, install from Maven in Driver Manager or import the driver and all dependency JARs together.",
  ...
  editor: {
    ...
    unsavedChangesBatchCloseMultipleMessage: '{count} SQL tabs you are closing have unsaved changes. Chiron Horizon is currently showing "{title}". Save before continuing?',
    unsavedChangesAppCloseMessage: '"{title}" has unsaved SQL changes that will be lost if you quit Chiron Horizon. Save before quitting?',
    unsavedChangesAppCloseMultipleMessage: '{count} SQL tabs have unsaved changes. Chiron Horizon is currently showing "{title}". Save before quitting?',
  ...
  tabs: {
    ...
    externalFileMissing: "Deleted or moved outside Chiron Horizon",
  ...
  grid: {
    ...
    esDeepPageJumpConfirmMessage:
      "Elasticsearch search_after cannot jump directly to a page. Chiron Horizon must fetch missing cursors in order, and backward navigation restarts from page 1. Jumping to page {page} is expected to send {requests} queries. This may take a long time and increase cluster load. Continue?",
    ...
    conditionalBulkEditConfirmMessage: "This executes immediately against every row matching the condition at execution time. Unloaded rows are included, and Chiron Horizon cannot generate a reliable rollback for them.",
    ...
    queryEditUnsupported: {
      ...
      "complex-source": "Chiron Horizon could not identify exactly one safe writeback target table for this result.",
      ...
      "metadata-unavailable": "Chiron Horizon could not load table metadata, so result editing is disabled.",
    },
  ...
  configExport: {
    ...
    cryptoUnavailable: "Encrypted config import is unavailable in this browser context. Use HTTPS, localhost, or Chiron Horizon Desktop.",
  ...
  ai: {
    ...
    closeWithRunsDescription: "Quitting Chiron Horizon will interrupt {count} running or queued AI task(s). You can close this dialog and let them finish instead.",
    ...
    productionWriteBlocked: "AI cannot execute data or schema changes on a production database. Review this SQL and run it manually in Chiron Horizon.",
    ...
    customHeadersReserved: "This header is managed by Chiron Horizon: {name}",
    ...
    codexCliEnvReservedName: "{name} is managed by Chiron Horizon for the MCP server and cannot be set here.",
    cliMcpRequiredTitle: "Chiron Horizon MCP Server required",
    cliMcpRequiredDescription: "{provider} uses the Chiron Horizon MCP Server to access database schema and query tools. Install it before using this provider in the AI assistant.",
    ...
    cliEnvReservedName: "{name} is managed by Chiron Horizon for the MCP server and cannot be set here.",
    codexMcpRequiredTitle: "Chiron Horizon MCP Server required",
    codexMcpRequiredDescription: "Codex CLI uses the Chiron Horizon MCP Server to access database schema and query tools. Install it before using Codex in the AI assistant.",
    ...
    cliErrors: {
      ...
      claudeCodeEnvReserved: "A CHIRON-HORIZON-managed MCP environment variable was overridden. Remove CHIRON_HORIZON_MCP_* variables from the provider configuration.",
      claudeCodeNotAuthenticated: "Claude Code CLI is not authenticated. Run `claude auth login` in a terminal and try again.",
      claudeCodeMcpConfigInvalid: "Claude Code could not read or parse the Chiron Horizon MCP configuration. Check the Claude Code CLI version and executable path.",
      chiron_horizonMcpMissing: "A compatible Chiron Horizon MCP Server installation was not found. Check Settings > MCP, then reinstall or update it.",
      claudeCodeMcpStartupFailed: "Claude Code loaded the MCP configuration but could not start Chiron Horizon MCP Server. Check Settings > MCP and the diagnostics below.",
      claudeCodeCommandLineTooLong: "Windows rejected the Claude Code command because it was too long. Update Chiron Horizon and retry using the generated MCP configuration file.",
      ...
      piAgentEnvReserved: "A CHIRON-HORIZON-managed Pi or MCP environment variable was overridden. Remove CHIRON_HORIZON_PI_* and CHIRON_HORIZON_MCP_* variables from the provider configuration.",
      ...
      piAgentMcpStartupFailed: "Pi could not start the scoped Chiron Horizon MCP bridge. Check Settings > MCP and the diagnostics below.",
      ...
      openCodeEnvReserved: "An OpenCode or CHIRON-HORIZON-managed environment variable was overridden. Remove OPENCODE control variables and CHIRON_HORIZON_MCP_* variables from the provider configuration.",
      ...
      openCodeMcpStartupFailed: "OpenCode could not start the scoped Chiron Horizon MCP server. Check Settings > MCP and the diagnostics below.",
      ...
      grokCliEnvReserved: "A CHIRON-HORIZON-managed MCP environment variable was overridden. Remove CHIRON_HORIZON_MCP_* variables from the provider configuration.",
      grokCliNotAuthenticated: "Grok CLI is not authenticated. Run `grok login` in a terminal and try again.",
      grokCliMcpStartupFailed: "Grok loaded the MCP configuration but could not start Chiron Horizon MCP Server. Check Settings > MCP and the diagnostics below.",
      grokCliCommandLineTooLong: "Windows rejected the Grok CLI command because it was too long. Update Chiron Horizon and retry using the generated prompt file.",
      ...
      codeBuddyEnvReserved: "A CHIRON-HORIZON-managed MCP environment variable was overridden. Remove CHIRON_HORIZON_MCP_* variables from the provider configuration.",
      ...
      codeBuddyMcpConfigInvalid: "CodeBuddy Code could not read the temporary Chiron Horizon MCP configuration. Check the diagnostics below.",
      codeBuddyMcpStartupFailed: "CodeBuddy Code loaded the MCP configuration but could not start Chiron Horizon MCP Server. Check Settings > MCP and the diagnostics below.",
      ...
      qoderEnvReserved: "A CHIRON-HORIZON-managed MCP environment variable was overridden. Remove CHIRON_HORIZON_MCP_* variables from the provider configuration.",
      ...
      qoderMcpConfigInvalid: "Qoder CLI could not read the temporary Chiron Horizon MCP configuration. Check the Qoder CLI version and diagnostics below.",
      qoderMcpStartupFailed: "Qoder CLI loaded the MCP configuration but could not start Chiron Horizon MCP Server. Check Settings > MCP and the diagnostics below.",
      ...
      cursorEnvReserved: "A Cursor or CHIRON-HORIZON-managed environment variable was overridden. Remove CURSOR_CONFIG_DIR, CURSOR_DATA_DIR, and CHIRON_HORIZON_MCP_* variables from the provider configuration.",
      cursorNotAuthenticated: "Cursor CLI is not authenticated. Run `agent login` in a terminal and try again.",
      cursorMcpStartupFailed: "Cursor could not start the scoped Chiron Horizon MCP server. Check Settings > MCP and the diagnostics below.",
    ...
    htmlCopyRiskBody: "This HTML was AI-generated. Opening it outside Chiron Horizon may execute scripts and access the network.",
    htmlCopyRiskAccept: "Copy anyway",
    htmlCopyRiskRemember: "Don't ask again this session",
    htmlCopyRiskToast: "Copied. This AI-generated HTML may execute scripts or access the network when opened outside Chiron Horizon.",
  ...
  contextMenu: {
    ...
    parameterDefaultHint: "When DEFAULT is checked, Chiron Horizon omits that argument so the database uses the procedure default.",
  ...
  structureEditor: {
    ...
    geometryEmptyTypeHint: "Empty geometry type equals GEOMETRY (any sub-type); chiron_horizon emits geometry(GEOMETRY, SRID).",
  ...
  diagram: {
    ...
    foreignKeysUnavailable: "Foreign-key metadata is unavailable for one or more tables. The ERD shows the tables and metadata that the driver returned.",
  ...
  schemaViewer: {
    title: "Schema Viewer",
    description: "Inspect declared native metadata without sampling your data.",
    connection: "Connection",
    scope: "Scope",
    optionalScope: "Select or enter a target",
    selectCollection: "Select a collection or index first.",
    selectScope: "Select a measurement or table first.",
    openErd: "Open ERD",
    load: "Load schema",
    refresh: "Refresh targets",
    loadingScopes: "Loading available targets…",
    noConnections: "No connected database exposes schema-view metadata yet.",
    schemaAbsent: "This connection does not expose a declared schema for the selected target. Chiron Horizon did not inspect document samples.",
    metagraph: "Native graph metadata",
  },
  etcd: {
    ...
    access: {
      ...
      permissionUpdateHint: "etcd Auth has no atomic update. Saving revokes the old permission and then grants the new one. If granting fails, Chiron Horizon attempts to restore the old permission.",
      saveChanges: "Save changes",
    ...
    dashboard: {
      ...
      metricsUnavailableHint: "Cluster status remains available. Chiron Horizon requests /metrics directly from the current etcd endpoint; verify that the resulting URL is reachable from the Chiron Horizon application.",
  ...
  sqlParameters: {
    ...
    description: "Fill values for SQL template placeholders. Chiron Horizon replaces them before executing the SQL.",
    name: "Parameter",
    syntax: "Syntax",
    type: "Type",
    value: "Value",
  ...
  settings: {
    ...
    uiFontAppDefault: "Chiron Horizon Default",
    ...
    iconThemeDefaultDescription: "Use the color Chiron Horizon app icon.",
    iconThemeBlack: "Black",
    iconThemeBlackDescription: "Use the black Chiron Horizon logo in the app.",
    ...
    showTrayIconDescription: "When disabled, no icon is shown, but closing the window still hides Chiron Horizon in the background as before.",
    quitOnClose: "Quit when closing window",
    quitOnCloseDescription: "When enabled, clicking the close button exits Chiron Horizon completely instead of hiding it to the tray. You can change this later in Appearance settings.",
    ...
    closeActionQuit: "Quit Chiron Horizon",
    ...
    duckDbWorkerProcessIsolationDescription: "Runs DuckDB queries in a separate worker process. If a long query does not respond to cancellation, Chiron Horizon can stop the worker process to release the database file lock.",
    duckDbWorkerMaxProcesses: "DuckDB max concurrent workers",
    duckDbWorkerMaxProcessesDescription: "Limits how many DuckDB worker processes Chiron Horizon can run at the same time. Range: 1-16. Default: 4.",
    duckDbWorkerProcessIsolationRestartRequired: "Restart Chiron Horizon for this change to take effect.",
    restartChironHorizon: "Restart Chiron Horizon",
    restartChironHorizonFailed: "Failed to restart Chiron Horizon: {error}",
    ...
    openTabsRestoreModeDescription: "Choose how Chiron Horizon restores tabs that were open last time.",
    ...
    syncWebDavDescription: "Upload or restore a Chiron Horizon snapshot, including saved SQL library entries, from a WebDAV-compatible storage service.",
    syncWebDavWebDescription: "In Web mode, the Chiron Horizon server accesses WebDAV without browser CORS restrictions. Saved passwords remain in the current Chiron Horizon instance.",
    ...
    syncRememberWebDavPasswordDescription: "The password is encrypted and stored in the current Chiron Horizon instance only. It is not synced to WebDAV and does not replace the sync password.",
    syncRemotePath: "Remote snapshot path",
    syncRemotePathDescription: "Chiron Horizon will create missing parent folders when uploading.",
    syncSecretNotice: "By default, Chiron Horizon syncs connection details and settings only. Database passwords, SSH passwords, proxy passwords, HTTP tunnel tokens, connection strings, and AI API keys stay local.",
    syncSecrets: "Sync encrypted secrets",
    syncSecretsDescription: "When enabled, Chiron Horizon encrypts database passwords, SSH passwords, proxy passwords, HTTP tunnel tokens, and AI API keys before uploading them to remote storage.",
    ...
    syncSecretsPassphraseDescription: "This password is only used to encrypt and restore sensitive data. It is encrypted in the current Chiron Horizon instance; enter it again in other instances.",
    syncTest: "Test",
    syncUpload: "Upload",
    ...
    syncAutoUploadDescription: "Runs while Chiron Horizon is open. Downloads still require manual confirmation to avoid replacing local saved SQL unexpectedly.",
    ...
    syncDownloadConfirm: "Download and apply the remote Chiron Horizon snapshot? Local metadata and saved SQL will be replaced.",
    syncSnippetTitle: "GitHub / Gitee Snippet Sync",
    syncSnippetDescription: "Store the same Chiron Horizon snapshot in a private code snippet. The first upload creates a snippet and saves its ID.",
    ...
    syncSnippetMigrateLegacyConfirm: "Chiron Horizon will first create an encrypted replacement, then permanently delete legacy plaintext snippet {id}. This cannot be undone. Continue?",
    ...
    appCloseUnsavedTabsModeDescription: "Choose what happens when quitting Chiron Horizon while SQL tabs have unsaved edits.",
    appCloseUnsavedTabsModePrompt: "Ask whether to save",
    appCloseUnsavedTabsModeKeepDrafts: "Quit and keep drafts",
    appCloseUnsavedTabsModeHint: 'Drafts are kept as unsaved tabs and restored the next time you start Chiron Horizon. This requires "Restore tabs on launch" to not be set to "Do not keep tabs".',
    appCloseDraftPersistFailed: "Chiron Horizon could not save the open tab drafts, so quitting was cancelled. Check disk space and file permissions, then try again. Details: {message}",
    ...
    sqlVariableSyntaxDescription: "Choose which variable and placeholder syntaxes Chiron Horizon substitutes before running SQL, per database type. All are enabled by default.",
    ...
    jdbcPlugin: "Chiron Horizon JDBC plugin",
    ...
    mcpTitle: "MCP Server",
    mcpDescription: "Check the Chiron Horizon MCP Server installation and version used by Claude Code, Cursor, and other agents.",
    ...
    mcpUninstallConfirm: "Uninstall Chiron Horizon MCP Server? Configured MCP clients will no longer be able to start it.",
    mcpUninstallFailed: "Uninstallation failed: {error}",
    mcpConfig: "MCP config",
    mcpConfigOptionsHint:
      "Chiron Horizon centrally controls connection access and execution permissions for every MCP client. Generated configs contain only the runtime settings needed to start the MCP server and connect to this Chiron Horizon instance, with no permission or connection-scope variables.",
    mcpScopeConnection: "Connections allowed for MCP",
    mcpScopeConnectionDescription: "Chiron Horizon exposes only the selected connections to MCP. Changes apply to every MCP client.",
    ...
    mcpExecutionModeReadOnlyDescription: "Allows only requests Chiron Horizon classifies as reads; blocks recognized database writes and connection changes. Database-account permissions remain the final hard boundary.",
    ...
    mcpCapabilityDescription: "These are representative operations; requests Chiron Horizon cannot classify reliably require full access.",
    ...
    mcpDetectionTiming: "Chiron Horizon checks automatically when this page opens; use Check again to refresh.",
    mcpNpmBoundary: "Chiron Horizon checks MCP status; installation, upgrades, and uninstallation run through the detected npm or pnpm runtime.",
    ...
    mcpDatabaseScopePermissionNote: "The selected scope does not change the connection's existing database permissions in Chiron Horizon.",
    ...
    mcpHttpServiceDescription: "Off by default. When enabled, Chiron Horizon Desktop hosts the service; the configuration above is applied to the actual listening service only after saving.",
    ...
    mcpHttpErrorPortInUse: "The port is already used by another application. Chiron Horizon restarts its own MCP service when saving; close the other application using the port, or choose a different port.",
    ...
    mcpToolOpenTable: "Open table in Chiron Horizon",
    mcpToolExecuteAndShow: "Execute and show in Chiron Horizon",
    ...
    supportInfoAppVersion: "Chiron Horizon Version",
  ...
  driverStore: {
    ...
    jreDirRemoveFailedWindows:
      "Failed to remove the old JRE directory: {path}\nPossible causes:\n  - a chiron_horizon Agent / java process still holds the directory\n  - antivirus software is scanning it\nClose any process that may hold the directory, or restart chiron_horizon and try again.\n(original error: {error})",
    ...
    offlineExportDescription: "Select the CHIRON-HORIZON-managed Agent drivers to include. The package is compatible with the current platform only.",
    ...
    offlineExportNoDrivers: "No eligible CHIRON-HORIZON-managed Agent drivers are installed.",
    ...
    offlineExportSecurityHint: "Only CHIRON-HORIZON-managed artifacts and required managed JREs are included. Local paths, settings, and external drivers are excluded.",
    ...
    offlineExportUnavailable_unmanagedInstall: "This artifact is not tracked as a CHIRON-HORIZON-managed installation.",
    ...
    offlineExportUnavailable_missingManagedJre: "The required CHIRON-HORIZON-managed JRE is not installed.",
    offlineExportUnavailable_invalidManagedJre: "The required CHIRON-HORIZON-managed JRE is invalid or unsafe.",
    refresh: "Refresh",
    javaRuntime: "Java Runtime",
    javaRuntimeManaged: "Chiron Horizon managed JRE",
    ...
    localInstallHint: "For air-gapped machines: on another computer with internet access, download the official chiron-horizon-jdbc-plugin-*.zip from the Chiron Horizon GitHub Releases page, transfer it here, and select it — no network access is needed on this machine.",
    runtimeDrivers: "Runtime",
    pluginsTab: "Plugins",
    pluginContributionsTitle: "Frontend plugin contributions",
    pluginContributionsDescription: "Installed plugins can describe connection forms and other UI contributions without injecting code into the main Chiron Horizon window.",
  ...
  databaseBackup: {
    ...
    runtimeRequirement: "Scheduled backups run while Chiron Horizon is open, including when it is minimized to the tray.",
    ...
    fileNamePatternHint: "Use {'{'}schedule{'}'}, {'{'}date{'}'}, {'{'}timestamp{'}'}, {'{'}database{'}'}, and {'{'}runId{'}'}. Chiron Horizon adds a missing {'{'}database{'}'} value and adds the extension automatically.",
  ...
  mqExchanges: {
    ...
    namePlaceholder: "e.g. chiron-horizon-events",
    cancel: "Cancel",
    create: "Create",
    bind: "Bind",
    bindDialogTitle: "Bind to {name}",
    queueNamePlaceholder: "e.g. chiron-horizon-queue",
    exchangeNamePlaceholder: "e.g. chiron-horizon-events",
  ...
  nacos: {
    ...
    protectedRole: "The built-in administrator role cannot be removed from Chiron Horizon.",
    close: "Close",
    ...
    namespaceIdPlaceholder: "Leave empty for Chiron Horizon to generate a UUID",
    namespaceName: "Namespace Name",
    ...
    nacosDetectAccessibleNamespacesHint: "Chiron Horizon verifies configuration and service read access before offering namespaces for {name}.",
    ...
    nacosV3ConsoleManagedNamespacesHint: "This uses the Nacos 3 Console API (normally port 8080). Enter a namespace name or ID; Chiron Horizon converts a name to its actual ID when it can read the directory.",
    ...
    persistentInstanceHint: "Chiron Horizon does not register ephemeral instances because it cannot maintain their heartbeat.",
