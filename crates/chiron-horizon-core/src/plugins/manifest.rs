...
pub struct PluginEngines {
    #[serde(default, rename = "chiron-horizon")]
    pub chiron_horizon: String,
    #[serde(default)]
    pub host_api: String,
}
...
/// Native context-menu entry contributed to Chiron Horizon surfaces. v1 targets the
...
impl PluginManifest {
    ...
    pub fn compatibility(&self, plugin_dir: &Path, chiron_horizon_version: &str) -> PluginCompatibility {
        let mut errors = Vec::new();
        ...
        if self.manifest_version > 0 {
            ...
            validate_engine_requirement(
                "Chiron Horizon",
                &self.engines.chiron_horizon,
                chiron_horizon_version,
                &mut errors,
            );
...
mod tests {
    ...
    fn manifest_rejects_malformed_network_permissions() {
        ...
        let manifest: PluginManifest = serde_json::from_value(serde_json::json!({
            "manifest_version": 1,
            "id": "io.chiron.horizon.example",
            "name": "Example",
            "version": "1.0.0",
            "publisher": "example",
            "engines": { "chiron-horizon": ">=0.1.0", "host_api": "^1.0" },
    ...
    fn validates_manifest_v1_and_resolves_package_executable() {
        ...
        let manifest: PluginManifest = serde_json::from_value(serde_json::json!({
            ...
            "contributions": [{
                ...
                "id": "io.chiron.horizon.example.connection",
    ...
    fn validates_localized_plugin_metadata() {
        ...
        let manifest: PluginManifest = serde_json::from_value(serde_json::json!({
            "manifest_version": 1,
            "id": "io.chiron.horizon.localized",
            "name": "Localized",
            "version": "1.0.0",
            "publisher": "example",
            "engines": { "chiron-horizon": ">=0.1.0", "host_api": "^1.0" },
    ...
    fn rejects_obsolete_ui_kind_declaration() {
        ...
        let backend_error = serde_json::from_value::<PluginManifest>(serde_json::json!({
            "manifest_version": 1,
            "id": "io.chiron.horizon.backend-protocol",
            "name": "Backend protocol",
            "version": "1.0.0",
            "publisher": "example",
            "engines": { "chiron-horizon": ">=0.1.0", "host_api": "^1.0" },
            "entrypoints": { "backend": { "protocol": "chiron-horizon-jsonrpc", "executable": "bin/plugin" } }
        }))
        .unwrap_err();
    ...
    fn rejects_unknown_v1_top_level_fields_without_breaking_legacy_manifests() {
        ...
        let manifest: PluginManifest = serde_json::from_value(serde_json::json!({
            "manifest_version": 1,
            "id": "io.chiron.horizon.unknown-field",
            "name": "Unknown field",
            "version": "1.0.0",
            "publisher": "example",
            "engines": { "chiron-horizon": ">=0.1.0", "host_api": "^1.0" },
    ...
    fn rejects_legacy_runtime_declarations_in_manifest_v1() {
        ...
        let manifest: PluginManifest = serde_json::from_value(serde_json::json!({
            "manifest_version": 1,
            "id": "io.chiron.horizon.mixed-contract",
            "name": "Mixed contract",
            "version": "1.0.0",
            "publisher": "example",
            "engines": { "chiron-horizon": ">=0.1.0", "host_api": "^1.0" },
    ...
    fn legacy_manifest_remains_readable() {
        ...
        assert_eq!(manifest.backend_entrypoint().unwrap().executable, "bin/chiron-horizon-jdbc-plugin");
    }
    ...
    fn accepts_supported_connection_field_bindings() {
        ...
        let manifest: PluginManifest = serde_json::from_value(serde_json::json!({
            "manifest_version": 1,
            "id": "io.chiron.horizon.connection-bindings",
    ...
    fn rejects_unknown_connection_field_binding() {
        let error = serde_json::from_value::<PluginManifest>(serde_json::json!({
            "manifest_version": 1,
            "id": "io.chiron.horizon.invalid-binding",
    ...
    fn rejects_incompatible_field_defaults_and_missing_provider_references() {
        ...
        let manifest: PluginManifest = serde_json::from_value(serde_json::json!({
            "manifest_version": 1,
            "id": "io.chiron.horizon.invalid-contract",
    ...
    fn rejects_invalid_filesystem_root_and_missing_reference() {
        ...
        let manifest: PluginManifest = serde_json::from_value(serde_json::json!({
            "manifest_version": 1,
            "id": "io.chiron.horizon.invalid-files",
            "name": "Invalid files",
            "version": "1.0.0",
            "publisher": "example",
            "engines": { "chiron-horizon": ">=0.1.0", "host_api": "^1.0" },
    ...
    fn parses_composite_form_field_conditions() {
        ...
        let manifest: PluginManifest = serde_json::from_value(serde_json::json!({
            "manifest_version": 1,
            "id": "id.chiron.horizon.conditions",
            "name": "Conditions",
            "version": "1.0.0",
            "publisher": "example",
            "engines": { "chiron_horizon": ">=0.1.0", "host_api": "^1.0" },
